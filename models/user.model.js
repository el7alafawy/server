...
userSchema.methods.SignAccessToken = function () {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, jsonwebtoken_1.default.sign({ id: this._id }, process.env.ACCESS_TOKEN || '', { expiresIn: "".concat(accessTokenExpire, "m") })];
        });
    });
};
//Sign Refresh Token
userSchema.methods.SignRefreshToken = function () {
    return __awaiter(this, void 0, void 0, function () {
        var refreshTokenExpire;
        return __generator(this, function (_a) {
            refreshTokenExpire = parseInt(process.env.REFRESH_TOKEN_EXPIRE || '7', 10);
            return [2 /*return*/, jsonwebtoken_1.default.sign({ id: this._id }, process.env.REFRESH_TOKEN || '', { expiresIn: "".concat(refreshTokenExpire, "d") })];
        });
    });
};
//Compare password

...
var sendToken = function (user, statusCode, res) { return __awaiter(void 0, void 0, void 0, function () {
    var accessToken, refreshToken;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, user.SignAccessToken()];
            case 1:
                accessToken = _a.sent();
                return [4 /*yield*/, user.SignRefreshToken()];
            case 2:
